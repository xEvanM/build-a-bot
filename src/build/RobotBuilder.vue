...
export default {
  ...
  methods: {
    selectNextHead() { // function to select next head
      this.selectedHeadIndex = getNextValidIndex(
        this.selectedHeadIndex,
        availableParts.heads.length,
      );
    },
    selectPrevHead() { // function to select previous head
      this.selectedHeadIndex = getPrevValidIndex(
        this.selectedHeadIndex,
        availableParts.heads.length,
      );
    },
    selectNextLeftArm() { // function to select previous head
      this.selectedLeftArmIndex = getPrevValidIndex(
        this.selectedLeftArmIndex,
        availableParts.arms.length,
      );
    },
    selectPrevLeftArm() { // function to select previous head
      this.selectedLeftArmIndex = getPrevValidIndex(
        this.selectedLeftArmIndex,
        availableParts.arms.length,
      );
    },
    selectNextTorso() { // function to select previous head
      this.selectedTorsoIndex = getPrevValidIndex(
        this.selectedTorsoIndex,
        availableParts.torsos.length,
      );
    },
    selectPrevTorso() { // function to select previous head
      this.selectedTorsoIndex = getPrevValidIndex(
        this.selectedTorsoIndex,
        availableParts.torsos.length,
      );
    },
    selectNextRightArm() { // function to select previous head
      this.selectedRightArmIndex = getPrevValidIndex(
        this.selectedRightArmIndex,
        availableParts.arms.length,
      );
    },
    selectPrevRightArm() { // function to select previous head
      this.selectedRightArmIndex = getPrevValidIndex(
        this.selectedRightArmIndex,
        availableParts.arms.length,
      );
    },
    selectNextBase() { // function to select previous head
      this.selectedBaseIndex = getPrevValidIndex(
        this.selectedBaseIndex,
        availableParts.bases.length,
      );
    },
    selectPrevBase() { // function to select previous head
      this.selectedBaseIndex = getPrevValidIndex(
        this.selectedBaseIndex,
        availableParts.bases.length,
      );
